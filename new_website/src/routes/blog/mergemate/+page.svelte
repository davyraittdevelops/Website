<script lang="ts">
  ...
  const title = "How I built MergeMate: a Serverless Code Review Assistant";
  const date = "December 15, 2024";
  const category = "DevOps";
  const readTime = "12 min read";
  const excerpt = "Walk through how our team built a serverless code review assistant using AWS Bedrock and GitLab. See how we tackled the challenges of code reviews at scale and turned them into a streamlined, automated process.";
