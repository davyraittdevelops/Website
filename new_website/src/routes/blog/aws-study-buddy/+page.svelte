<script lang="ts">
  ...
  const title = "How I created my own Flutter app to study for AWS Certifications";
  const date = "November 10, 2024";
  const category = "Flutter";
  const readTime = "5 min read";
  const excerpt = "In this blog, I show how I built a custom \"Study Buddy\" app in Flutter to help me learn AWS content on the go. You will see how I track scores, display explanations, and even allow \"Endless Mode\" for long study sessions.";
